...
// const ProjectCard = ({ title, des, src, gitlink, hostlink }) => {
//   const openGitLink = () => {
...
//               <BsGithub />
//             </span>
//             <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400 hover:text-designColor duration-200 cursor-pointer"
//             onClick={openHosting}>
//               <FaGlobe />
//             </span>
//           </div>
